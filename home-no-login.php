    ...
    <div class="boxcontent">
        <div class="boxcontent_konten0">
            <div class="boxcontent_konten0-teks">
                ...
                <button type="submit" onclick="window.location.href='belanja-no-login.php'" style="font-weight: 700; font-size: 20px; width: 160px; height: 40px;">Beli Sekarang!</button>
            </div>
        ...
        <div class="boxcontent_konten2">
            ...
            <div class="boxcontent_konten2-button">
                <button onclick="window.location.href='belanja-no-login.php'" style="width: 123px; height: 42px;">Semua</button>
                <button onclick="window.location.href='rempah-kering-no-login.php'" style="width: 250px; height: 42px;">Rempah Kering</button>
                <button onclick="window.location.href='rempah-basah-no-login.php'" style="width: 250px; height: 42px;">Rempah Basah</button>
                <div>
