...
<body>
    ...
    <div class="boxcontent">
        ...
        <div class="boxcontent-rempah1">
            <button type="submit" onclick="window.location.href='belanja.php'" style="width: 123px; height: 42px; margin-bottom: 20px;">Semua</button>
            <button type="submit" onclick="window.location.href='rempah-kering.php'" style="width: 250px; height: 42px; margin-bottom: 20px;">Rempah Kering</button>
            <button type="submit" onclick="window.location.href='rempah-basah.php'" style="width: 250px; height: 42px; margin-bottom: 20px;">Rempah Basah</button>
        </div>
        <h2 style="padding-bottom: 20px;"><?php echo $_GET['search']?></h2>
        <div class="boxcontent-rempah1-isi">
            <?php
            include "config.php";
            $sql = mysqli_query($conn, "SELECT * FROM rempah WHERE nama_rempah LIKE '%".$_GET['search']."%'");
            ...
            <?php }else { ?>
                <center><h1><?php echo$_GET['search']. ' tidak ditemukan!'; ?></h1></center>
            <?php }?>
        </div>
    </div>
